...
Alternativa considerada: tabela própria unificando os dois. Rejeitada porque duplicaria o trigger `trg_eloi_orcamento_aprovado` (que já cria o serviço automaticamente e é a fonte de verdade do vínculo) e arriscaria os dois lados dessincronizarem. Ver termo "Projeto" em `CONTEXT.md`.
